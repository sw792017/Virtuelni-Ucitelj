...
public class DroolsTest extends UnitTest{
    ...
    public void RasporedTest_DvaTestaSaIstimPrioritetom(){
        ...
        String ocekivano1 = "3@Vezbaj Tapkanje na 2 zice 1h|Vezbaj Hammeron-pulloff-over 30min|Vezbaj Hammeron-pulloff-over 30min";
        String ocekivano2 = "3@Vezbaj Tapkanje na 2 zice 1h|Vezbaj Hammeron-pulloff-over 30min|Vezbaj Menjanje akorda Am, A, Dm, D 30min";
    ...
    public void RasporedTest_DvaTestaSaIstimPrioritetomNaIvici(){
        ...
        String ocekivano1 = "3@Vezbaj Tapkanje na 2 zice 1h|Vezbaj Menjanje akorda Am, A, Dm, D 30min|Vezbaj Menjanje akorda E5, A5, C5 30min";
        String ocekivano2 = "3@Vezbaj Tapkanje na 2 zice 1h|Vezbaj Menjanje akorda Am, A, Dm, D 30min|Vezbaj Sweep picking 30min";
    ...
    @Test
    public void RasporedTest_CustomZadatak(){
        ...
        String ocekivano = "3@Vezbaj Tapkanje na 2 zice 1h|Vezbaj Menjanje akorda Am, A, Dm, D 30min|Vezbaj Menjanje akorda E5, A5, C5 30min|Vezbaj Menjanje akorda E5, A5, C5 30min";
    ...
    @Test
    public void RasporedTest_LegacyZadatak(){
    ...
    public void RasporedTest_LegacyZadatakICustomZadatakSaZadacima1i3() {
        String ulaz = ("2" + "[_]" + "3@|Vezbaj Tapkanje na 2 zice 1h|Vezbaj Menjanje akorda Am, A, Dm, D 30min|Vezbaj Menjanje akorda E5, A5, C5 30min" + "[_]" + tehnike).replace("|01/06/2021|", "|01/05/2021|");
        String ocekivano = "3@Vezbaj Tapkanje na 2 zice 1h|Vezbaj Tapkanje na 2 zice 1h|Vezbaj Menjanje akorda Am, A, Dm, D 30min|Vezbaj Menjanje akorda E5, A5, C5 30min";
